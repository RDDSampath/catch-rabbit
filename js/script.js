...
var maxSpeed = 40;
var monsterPos = .65;
var monsterPosTarget = .70;
var floorRotation = 0;
var collisionObstacle = 10;
var collisionBonus = 20;
var gameStatus = "play";
var cameraPosGame = 160;
var cameraPosGameOver = 220;
var monsterAcceleration = 0.003;
...
var catchSound = new Audio('audio/catch.mp3');
...
function initScreenAnd3D() {
  ...
  // Subway Surfers Style Positioning
  camera.position.x = 0;
  camera.position.z = cameraPosGame; // Behind the rabbit
  camera.position.y = 100;           // High up looking down
...
Hero.prototype.jump = function(){
  ...
  this.status = "jumping";
  // --- PLAY JUMP SOUND ---
  jumpSound.currentTime = 0; // Reset to start for fast consecutive jumps
  jumpSound.play().catch(e => console.log("Audio play blocked"));
  // -----------------------
  var _this = this;
...
function gameOver(){
  ...
  gameStatus = "gameOver";
  // --- PLAY SOUNDS ---
  audio.pause();            // Stop the main background music
  catchSound.play();        // Play the "Gotcha!" sound
  
  // Play game over theme after a tiny delay, or immediately
  setTimeout(function(){
      gameOverSound.play();
  }, 1000);
  // -------------------
...
function getBonus(){
  ...
  // --- PLAY SOUND ---
  bonusSound.currentTime = 0; // Reset to start if already playing
  bonusSound.play();
  // ------------------
